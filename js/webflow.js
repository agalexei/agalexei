...
Webflow.define('scroll', module.exports = function ($) {
  ...
  function scroll($targetEl, cb) {
    ...
    if (start === end) return;
    var duration = calculateScrollDuration($targetEl, start, end) - 1800;
    var clock = Date.now();
